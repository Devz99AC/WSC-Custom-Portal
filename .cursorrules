...
> 📌 **State as of 2026-08-06: 11/18.** Live at **`portal.wholesaleshelfcorporations.com`** (Vercel + Railway + Redis, still behind HTTP Basic Auth). Six sections: **Orders · Payments · Documents · Learning Center · Support · Profile**. Gates: typecheck 4/4, lint clean, build 3/3, 90 tests.
>
